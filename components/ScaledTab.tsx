...
const Scaledtab: React.FC<ScaledTabProps> = ({
  icon,
  name,
  active,
  onClick,
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={cn(
        "flex items-center justify-center py-3 px-5 rounded-full cursor-pointer focus:outline-none transition-colors duration-200",
        active
