        ...
        <div className="flex flex-col gap-y-4">
          <BoxReveal boxColor={"#a6a2eb"} duration={0.5}>
            <p className="text-[1.5rem] font-semibold">
              Full Stack Engineer at Taiwan.
            </p>
          </BoxReveal>

          <BoxReveal boxColor={"#a6a2eb"} duration={0.5}>
            <h2 className="mt-[.5rem] text-[1rem]">
              Passionate about building high-performance and user-friendly
              applications.
            </h2>
          </BoxReveal>
          ...
          <BoxReveal boxColor={"#a6a2eb"} duration={0.5}>
            <h2 className="mt-[.5rem] text-[1rem]">
              Love exploring new technologies and applying them to real-world
              projects to solve complex problems.
            </h2>
          </BoxReveal>
